...
class Response
{
    public static function responde($data, $status_code = self::HTTP_OK)
    {
        # set http haeder
        ...
        $response = [
            ...
            'http_message' => self::StatusText[$status_code],
            'data' => $data
        ];
        # convert response to json and return
        return json_encode($response, JSON_UNESCAPED_UNICODE);
    }
    public static function RespondeAndDie($data, $status_code = self::HTTP_OK)
    {
        die(self::responde($data, $status_code));
    }
